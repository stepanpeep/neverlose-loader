...
The release ZIP intentionally contains only `NeverloseLoader.exe` and `assets/`. The `manifest/` folder stays in the GitHub repository as the official remote configuration and is not copied next to the executable.
